...
class clickSurUserAction extends Action
{
    ...
    public function execute(): string
    {
        ...
        foreach ($listes as $liste) {
            ...
            if (strlen($liste['contentTouite']) > 100) {
                $txt2 .= "<a href=\"affichage_tweet.php?touite=" . $liste['idTouite'] . "&page=profil\"><p>" . substr($liste['contentTouite'], 0, 100). "..." . "</p></a>";
            } else {
                $txt .= "<a href=\"affichage_tweet.php?touite=" . $liste['idTouite'] . "&page=profil\"><p>" . $liste['contentTouite']. "</p></a>";
            }
        ...
        $id = GestionUser::getIdByUsername($_SESSION['user']);
        $txt3 = GestionUser::userAbonne($id);
